...
5. docker run -it -d --name r1 -p 5001:6379 -v /usr/local/redis-5.0.8:/etc/redis -v /root/usr/local/redis/data:/data  --net mynetwork --net=net2 --ip 172.19.0.2 redis bash

6. 

7. redis-cli --cluster create 172.19.0.12:6379 172.19.0.13:6379 172.19.0.14:6379 172.19.0.15:6379 172.19.0.16:6379 172.19.0.17:6379 --cluster-replicas 1

   ```shell
   docker run -it -d --name r1 -p 5011:6379 -v /opt/redis:/usr/local/redis -v /root/usr/local/redis/data:/data  --net=net2 --ip 172.19.0.12 redis bash
   
   docker run -it -d --name r12 -p 5012:6379 -v /opt/redis:/usr/local/redis -v /root/usr/local/redis/data:/data --net=net2 --ip 172.19.0.13 redis bash
   
   docker run -it -d --name r13 -p 5013:6379 -v /opt/redis:/usr/local/redis -v /root/usr/local/redis/data:/data --net=net2 --ip 172.19.0.14 redis bash
   
   docker run -it -d --name r14 -p 5014:6379 -v /opt/redis:/usr/local/redis -v /root/usr/local/redis/data:/data --net=net2 --ip 172.19.0.15 redis bash
   
   docker run -it -d --name r15 -p 5015:6379 -v /opt/redis:/usr/local/redis -v /root/usr/local/redis/data:/data --net=net2 --ip 172.19.0.16 redis bash
   
   docker run -it -d --name r16 -p 5016:6379 -v /opt/redis:/usr/local/redis -v /root/usr/local/redis/data:/data --net=net2 --ip 172.19.0.17 redis bash
   ```
...
![image-20200501090146680](C:\Users\ASUS\AppData\Roaming\Typora\typora-user-images\image-20200501090146680.png)

![image-20200501090208512](C:\Users\ASUS\AppData\Roaming\Typora\typora-user-images\image-20200501090208512.png)

![image-20200501090340092](C:\Users\ASUS\AppData\Roaming\Typora\typora-user-images\image-20200501090340092.png)

![image-20200501090402539](C:\Users\ASUS\AppData\Roaming\Typora\typora-user-images\image-20200501090402539.png)

![image-20200501090611689](C:\Users\ASUS\AppData\Roaming\Typora\typora-user-images\image-20200501090611689.png)
